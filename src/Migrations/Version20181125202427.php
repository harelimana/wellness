 ...
 */
final class Version20181125202427 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, codepostal_id INT DEFAULT NULL, localite_id INT DEFAULT NULL, commune_id INT DEFAULT NULL, address_number VARCHAR(16) NOT NULL, address_rue VARCHAR(32) NOT NULL, email VARCHAR(32) NOT NULL, banni TINYINT(1) NOT NULL, inscription TINYINT(1) NOT NULL, inscription_date DATETIME DEFAULT NULL, password VARCHAR(32) NOT NULL, success_attempt INT DEFAULT NULL, userType VARCHAR(255) NOT NULL, INDEX IDX_8D93D649C9B1D722 (codepostal_id), INDEX IDX_8D93D649924DD2B5 (localite_id), INDEX IDX_8D93D649131A4F72 (commune_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE prestataire (id INT NOT NULL, image_id INT DEFAULT NULL, logo_id INT NOT NULL, stages_id INT DEFAULT NULL, services_id INT DEFAULT NULL, name VARCHAR(45) NOT NULL, telnumber VARCHAR(255) DEFAULT NULL, tvanumber VARCHAR(255) NOT NULL, website VARCHAR(45) NOT NULL, slug VARCHAR(45) NOT NULL, UNIQUE INDEX UNIQ_60A26480989D9B62 (slug), UNIQUE INDEX UNIQ_60A264803DA5256D (image_id), UNIQUE INDEX UNIQ_60A26480F98F144A (logo_id), INDEX IDX_60A264808E55E70A (stages_id), INDEX IDX_60A26480AEF5A6C1 (services_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service_prestataire (service_id INT NOT NULL, prestataire_id INT NOT NULL, INDEX IDX_AC38422CED5CA9E6 (service_id), INDEX IDX_AC38422CBE3DB2B7 (prestataire_id), PRIMARY KEY(service_id, prestataire_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, affichage_debut DATETIME NOT NULL, affichage_fin DATETIME NOT NULL, debut_stage DATETIME NOT NULL, fin_stage DATETIME NOT NULL, description VARCHAR(128) NOT NULL, more_info VARCHAR(64) DEFAULT NULL, name VARCHAR(45) NOT NULL, tarif VARCHAR(45) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE prestataire ADD CONSTRAINT FK_60A264808E55E70A FOREIGN KEY (stages_id) REFERENCES stage (id)');
        $this->addSql('ALTER TABLE prestataire ADD CONSTRAINT FK_60A26480AEF5A6C1 FOREIGN KEY (services_id) REFERENCES service (id)');
        ...
        $this->addSql('ALTER TABLE service_prestataire ADD CONSTRAINT FK_AC38422CED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE service_prestataire ADD CONSTRAINT FK_AC38422CBE3DB2B7 FOREIGN KEY (prestataire_id) REFERENCES prestataire (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE service_prestataire DROP FOREIGN KEY FK_AC38422CBE3DB2B7');
        $this->addSql('ALTER TABLE prestataire DROP FOREIGN KEY FK_60A26480AEF5A6C1');
        $this->addSql('ALTER TABLE service_prestataire DROP FOREIGN KEY FK_AC38422CED5CA9E6');
        ...
        $this->addSql('ALTER TABLE prestataire DROP FOREIGN KEY FK_60A264808E55E70A');
        ...
        $this->addSql('DROP TABLE service_prestataire');
