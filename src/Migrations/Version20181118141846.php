 ...
 */
final class Version20181118141846 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, prestataire_id INT NOT NULL, affichage_debut DATETIME NOT NULL, affichage_fin DATETIME NOT NULL, debut_stage DATETIME NOT NULL, fin_stage DATETIME NOT NULL, description VARCHAR(128) NOT NULL, more_info VARCHAR(64) DEFAULT NULL, name VARCHAR(45) NOT NULL, tarif VARCHAR(45) NOT NULL, INDEX IDX_C27C9369BE3DB2B7 (prestataire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
